...
const add_reminder_dto_1 = require("./dto/add-reminder.dto");
...
let RemindersController = class RemindersController {
    ...
    postNotes(req, addReminders) {
        this.remindersService.addUserReminders(addReminders, req.user.id, +req.params.goalId);
    }
};
__decorate([
...
], RemindersController.prototype, "getGoals", null);
__decorate([
    ...
    __metadata("design:type", Function),
    __metadata("design:paramtypes", [Object, add_reminder_dto_1.AddReminderDto]),
    __metadata("design:returntype", void 0)
], RemindersController.prototype, "postNotes", null);
