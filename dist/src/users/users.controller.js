...
let UsersController = class UsersController {
    ...
    async createProfile(req, addUserProfileDto, image) {
        const imagePath = image ? image.path : null;
        const profileData = addUserProfileDto;
        return await this.usersService.createUserProfile(profileData, imagePath, req.user.id);
    }
...
__decorate([
    ...
    __metadata("design:type", Function),
    __metadata("design:paramtypes", [Object, add_user_dto_1.AddUserProfileDto, Object]),
    __metadata("design:returntype", Promise)
